function varargout = SharpGSDIM(varargin)
% SharpGSDIM MATLAB code for SharpGSDIM.fig
%      SharpGSDIM, by itself, creates a new SharpGSDIM or raises the existing
%      singleton*.
%
%      H = SharpGSDIM returns the handle to a new SharpGSDIM or the handle to
%      the existing singleton*.
%
%      SharpGSDIM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SharpGSDIM.M with the given input arguments.
%
%      SharpGSDIM('Property','Value',...) creates a new SharpGSDIM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SharpGSDIM_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SharpGSDIM_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SharpGSDIM

% Last Modified by GUIDE v2.5 19-Feb-2015 16:22:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SharpGSDIM_OpeningFcn, ...
                   'gui_OutputFcn',  @SharpGSDIM_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SharpGSDIM is made visible.
function SharpGSDIM_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SharpGSDIM (see VARARGIN)

% Choose default command line output for SharpGSDIM
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes SharpGSDIM wait for user response (see UIRESUME)
...
function varargout = SharpGSDIM_OutputFcn(hObject, eventdata, handles) 
